...
public interface BaseSuspendProcessRestController<
    ...
    Logger log = LoggerFactory.getLogger(BaseSuspendProcessRestController.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<Boolean>> suspend(ProcessCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
