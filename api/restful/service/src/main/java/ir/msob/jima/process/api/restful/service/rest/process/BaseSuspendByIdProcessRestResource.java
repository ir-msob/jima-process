...
public interface BaseSuspendByIdProcessRestResource<
    ...
    @Scope(Operations.SUSPEND_BY_ID)
    @MethodStats
    default ResponseEntity<Mono<ProcessDto>> suspendById(@PathVariable("id") String id, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
    ...
    default ResponseEntity<Mono<ProcessDto>> suspendByIdResponse(Mono<ProcessDto> result, Optional<USER> user) {
