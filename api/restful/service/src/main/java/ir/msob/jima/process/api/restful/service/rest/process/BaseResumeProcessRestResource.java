...
public interface BaseResumeProcessRestResource<
    ...
    @MethodStats
    default ResponseEntity<Mono<ProcessDto>> resume(ProcessCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
    ...
    default ResponseEntity<Mono<ProcessDto>> resumeResponse(Mono<ProcessDto> result, Optional<USER> user) {
