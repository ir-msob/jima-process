...
public interface BaseDeleteDeploymentRestController<
    ...
    Logger log = LoggerFactory.getLogger(BaseDeleteDeploymentRestController.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<Boolean>> delete(DeploymentCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
