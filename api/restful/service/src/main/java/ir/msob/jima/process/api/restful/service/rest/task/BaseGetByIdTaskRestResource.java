...
public interface BaseGetByIdTaskRestResource<
    ...
    @MethodStats
    default ResponseEntity<Mono<TaskDto>> getById(@PathVariable("id") String id, Principal principal) {
    ...
    default ResponseEntity<Mono<TaskDto>> getByIdResponse(Mono<TaskDto> result, Optional<USER> user) {
