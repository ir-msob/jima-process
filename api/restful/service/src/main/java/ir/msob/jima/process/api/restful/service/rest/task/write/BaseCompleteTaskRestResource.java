...
public interface BaseCompleteTaskRestResource<
    ...
    @Scope(operation = Operations.COMPLETE)
    @MethodStats
    default ResponseEntity<Mono<DTO>> complete(C criteria, DTO dto, Principal principal) {
    ...
    default ResponseEntity<Mono<DTO>> completeResponse(Mono<DTO> result, USER user) {
