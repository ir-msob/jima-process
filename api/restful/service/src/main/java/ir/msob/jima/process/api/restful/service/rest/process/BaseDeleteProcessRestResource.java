...
public interface BaseDeleteProcessRestResource<
    ...
    @MethodStats
    default ResponseEntity<Mono<String>> delete(ProcessCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
