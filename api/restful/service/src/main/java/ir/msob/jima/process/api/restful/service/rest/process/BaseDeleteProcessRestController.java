...
public interface BaseDeleteProcessRestController<
    ...
    Logger log = LoggerFactory.getLogger(BaseDeleteProcessRestController.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<Boolean>> delete(ProcessCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
