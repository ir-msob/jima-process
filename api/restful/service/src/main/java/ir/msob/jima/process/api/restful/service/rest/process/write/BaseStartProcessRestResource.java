...
public interface BaseStartProcessRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseStartProcessRestResource.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<DTO>> start(C criteria, @RequestBody DTO dto, ServerWebExchange serverWebExchange, Principal principal) {
    ...
    default ResponseEntity<Mono<DTO>> startResponse(Mono<DTO> result, USER user) {
