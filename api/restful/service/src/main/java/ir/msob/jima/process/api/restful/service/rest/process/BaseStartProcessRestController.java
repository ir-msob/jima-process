...
public interface BaseStartProcessRestController<
    ...
    Logger log = LoggerFactory.getLogger(BaseStartProcessRestController.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<ProcessDto>> start(@RequestBody ProcessDto dto, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
        log.debug("REST request to start process, dto {}", dto);
        ...
        return this.startResponse(this.getService().start(dto, user), user);
    }
