...
public interface BaseSuspendProcessRestResource<
    ...
    @MethodStats
    default ResponseEntity<Mono<DTO>> suspend(C criteria, ServerWebExchange serverWebExchange, Principal principal) {
    ...
    default ResponseEntity<Mono<DTO>> suspendResponse(Mono<DTO> result, USER user) {
