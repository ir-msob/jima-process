...
public interface BaseStartByIdProcessRestResource<
    ...
    @MethodStats
    default ResponseEntity<Mono<DTO>> startById(@PathVariable("id") String id, @RequestBody DTO dto, ServerWebExchange serverWebExchange, Principal principal) {
    ...
    default ResponseEntity<Mono<DTO>> startByIdResponse(Mono<DTO> result, USER user) {
